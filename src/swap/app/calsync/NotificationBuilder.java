	...
	public void BuildNotification(String title, String text)
	{
		...
		try
		{
			NotificationCompat.Builder mBuilder =
			        ...
			        //.setLargeIcon(BitmapFactory.decodeResource(instance.getResources(), R.drawable.notification_icon_adjusted))
			...
			//Toast.makeText(instance, "Notification built", Toast.LENGTH_SHORT).show();
		}
		catch(Exception e)
		{
			Log.e("", e.getMessage());
